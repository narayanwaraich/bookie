...
import * as folderService from '../../api/services/folder.service';
import { FolderError } from '../../api/services/folder.service';
...
describe('Folder TRPC Router', () => {
  ...
  describe('create', () => {
    it('should call folderService.createFolder and return the new folder', async () => {
      ...
      const input: inferProcedureInput<
        typeof appRouter.folders.create
      > = { name: 'TRPC Folder', parentId: undefined };
      const serviceResult = {
        id: folderId,
        ...input,
        userId,
        parentId: null,
      }; // Service might return null explicitly
  ...
  describe('list', () => {
    it('should call folderService.getUserFolders and return folders', async () => {
      ...
      mockFolderService.getUserFolders.mockResolvedValue(
        serviceResult as any
      );
      const caller = await createCaller();
  ...
  describe('getById', () => {
    it('should call folderService.getFolderById and return the folder', async () => {
      const input: inferProcedureInput<
        typeof appRouter.folders.getById
      > = { id: folderId };
      const serviceResult = {
        id: folderId,
        name: 'TRPC Get Folder',
        userId,
      };
  ...
  describe('update', () => {
    it('should call folderService.updateFolder', async () => {
      const input: inferProcedureInput<
        typeof appRouter.folders.update
      > = { id: folderId, name: 'Updated TRPC Folder' };
      const serviceResult = {
        id: folderId,
        name: input.name,
        userId,
  ...
  describe('delete', () => {
    it('should call folderService.deleteFolder', async () => {
      ...
      const input: inferProcedureInput<
        typeof appRouter.folders.delete
      > = { id: folderId, moveBookmarksTo: parentFolderId };
  ...
  describe('getBookmarks', () => {
    it('should call folderService.getBookmarksByFolder', async () => {
      const input: inferProcedureInput<
        typeof appRouter.folders.getBookmarks
      > = { folderId: folderId, limit: 10, offset: 0 };
      const serviceResult = {
        data: [],
        totalCount: 0,
        page: 1,
      ...
      mockFolderService.getBookmarksByFolder.mockResolvedValue(
        serviceResult as any
      );
      const caller = await createCaller();
  ...
  describe('addCollaborator', () => {
    it('should add collaborator successfully', async () => {
      const input: inferProcedureInput<
        typeof appRouter.folders.addCollaborator
      > = {
        folderId: folderId,
      ...
      mockFolderService.addCollaborator.mockResolvedValue(
        serviceResult as any
      );
      const caller = await createCaller();
  ...
  describe('updateCollaborator', () => {
    it('should update collaborator permission successfully', async () => {
      const input: inferProcedureInput<
        typeof appRouter.folders.updateCollaborator
      > = {
        folderId: folderId,
      ...
      mockFolderService.updateCollaboratorPermission.mockResolvedValue(
        serviceResult as any
      );
      const caller = await createCaller();
  ...
  describe('removeCollaborator', () => {
    it('should remove collaborator successfully', async () => {
      const input: inferProcedureInput<
        typeof appRouter.folders.removeCollaborator
      > = { folderId: folderId, collaboratorId: collaboratorUserId };
      mockFolderService.removeCollaborator.mockResolvedValue(
        undefined
      );
      const caller = await createCaller();
