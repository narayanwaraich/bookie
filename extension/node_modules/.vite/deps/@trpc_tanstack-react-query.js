...
// node_modules/.pnpm/@trpc+tanstack-react-query@11.4.3_@tanstack+react-query@5.83.0_react@19.1.1__@trpc+client@11._lvs2hlalcxhoovrx36bmksubgu/node_modules/@trpc/tanstack-react-query/dist/index.mjs
...
var import_objectSpread2$5 = __toESM2(require_objectSpread2(), 1);
...
var import_objectSpread2$4 = __toESM2(require_objectSpread2());
...
var import_objectSpread2$3 = __toESM2(require_objectSpread2());
...
var import_objectSpread2$2 = __toESM2(require_objectSpread2());
...
function useSubscription(opts) {
  ...
  const trackedProps = React$1.useRef(/* @__PURE__ */ new Set([]));
...
function createTRPCOptionsProxy(opts) {
  const callIt = (type) => {
    return (path, input, trpcOpts) => {
      if ("router" in opts) return Promise.resolve(unwrapLazyArg(opts.ctx)).then((ctx) => callProcedure({
        router: opts.router,
        path,
...
function createTRPCContext() {
  ...
  function TRPCProvider(props) {
    ...
    return (0, import_jsx_runtime.jsx)(TRPCClientContext.Provider, {
      value: props.trpcClient,
      children: (0, import_jsx_runtime.jsx)(TRPCContext.Provider, {
        value,
